        ...
        <div class="row">
          <div class="col-md-6 p-5 pt-0">
            <div class="row">
              ...
              <form>
                ...
                <button v-if="!isArtist" @click="updateUserData" type="button" class="btn btn-primary mt-3" style="background-color: #FF3131; border-color: #FF3131;">Actualizar</button>
          ...
          <div class="col-md-6" v-if="isArtist">
            <form>
                ...
                <button @click="updateUserData" type="button" class="btn btn-primary" style="background-color: #FF3131; border-color: #FF3131;">Actualizar</button>
          ...
          <div class="col-md-4 p-5 pt-0">
            ...
            <button @click="deleteAccount" type="button" class="btn btn-danger">Eliminar Cuenta</button>
          </div>
        </div>
      </div>
      <FooterComponent />
    ...
    export default {
        ...
        methods: {
            async getData() {
                ...
                try {
                    const response = await axios.get('http://127.0.0.1:5000/api/user/get/' + getAuth().currentUser.uid);
            ...
            async updateUserData() {
                try {
                    ...
                    await axios.put('http://127.0.0.1:5000/api/user/update/' + getAuth().currentUser.uid, userData);
                    this.errMsg = '';
            ...
            async deleteAccount() {
                try {
                    ...
                    await axios.delete('http://127.0.0.1:5000/api/user/delete/' + user.uid);
                    await user.delete();
                    this.$router.push('/');
                } catch (error) {
