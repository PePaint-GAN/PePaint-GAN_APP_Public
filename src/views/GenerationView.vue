<template>
    ...
    <h1 class="m-3" style="font-weight: bold; color: #FF3131;">
        Generación de la Pintura
    </h1>
        ...
        <div class="row">
            ...
            <div class="col-md-7 d-flex align-items-center ms-3" style="background-color: #B9AC92; height: 400px;">
                ...
                <div v-else class="col-12 d-flex justify-content-center align-items-center" style="height: 100%;">
                    <!-- Primera imagen con separación -->
                    <div v-for="(imageSrc, index) in imageSrcs" :key="index" class="mx-5"> <!-- Agrega una separación horizontal -->
                        <img
                            v-if="imageSrc"
                            :src="imageSrc"
                            :alt="'Image ' + (index + 1)"
            ...
            <div class="col-md-2" v-if="imageSrcs && imageSrcs.length > 0">
                <!-- Utiliza un bucle v-for para crear botones dinámicamente -->
                <button
                    v-for="(imageSrc, index) in imageSrcs"
                    :key="index"
                    class="btn btn-primary mb-3"
                    style="background-color: #FF3131; border-color: #FF3131;"
                    @click="guardarImagen(index)"
                >
...
export default {
    ...
    methods: {
        ...
        generarImagen() {
            ...
            axios.post('http://127.0.0.1:5000/api/painting/generate_images/' + this.selectedModel, requestData)
                .then((response) => {
        ...
        guardarImagen(opcion) {
            ...
            axios.post("http://127.0.0.1:5000/api/painting/add", paintingData)
                .then(response => {
